...
```
Пример обучения сети со 120 нейронами на скрытом слое в течение 10 эпох со скоростью 0.1 пачками по 30 изображений (по умолчанию тренеровочное множество состоит из 60000 элементов):
```
