...
## Тестирование
Windows 10 x64
процессор Intel Core i5-6600K, 4 ядра разогнанный до 4.3ГГц
...
Batch size: 30
```
На 9-ой эпохе функция потерь = 0.1030, а точность = 0.9711. Быстро достигается высокая точность на тестовой выборке, при этом не наблюдается переобучение.
